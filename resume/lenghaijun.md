...
* 上海幻电信息科技有限公司
* 8 年移动游戏开发, 4 年 `C++/cocos2d-x`, 4 年 `C#/Unity3D`
* 有多个成功项目上线经验, 如 `武侠转`/`幻想英雄`/`魔法少女小圆`/`A3满开剧团`
* GitHub: [cn00](https://github.com/cn00)

## 专业能力
* 熟悉 `Android`/`iOS`/`Linux`/`Docker` 系统, 擅长选择系统或开源工具解决日常开发问题,
* 掌握 `C++`/`C#`/`Lua`/`Shell`, 熟悉多线程/多进程并发编程技术, 能够熟练使用脚本及 `Jenkins` 自动化构建系统完成程序化工作
* 掌握 `git`/`svn` 版本控制和工作流以及其工具使用, 熟练使用二分法定位问题提交
* 掌握 `MySQL`/`SQLite` 等数据库, 擅长各种数据格式之间等转换
* 熟悉 `OSS`/`AWS`/`S3` 等对象存储存储系统
* 快速学习能力, 能够快速熟悉项目, 根据项目需求快速探索学习新语言新技术
* 具有丰富的开源项目组件使用经验, 按需要介入开源模块, 并根据项目需求进行二次开发
* 热爱开源社区, 积极为开源项目贡献代码, 如腾讯开源热更新方案 [xlua]()/[InjectFix](), 分布式构建系统 [distcc]()
