...
* 5 年移动游戏开发, 其中 3 年 `C++`, 1 年 `C++ + Lua`, 1.5 年 `C# + Lua`
* 3 款成功上线产品, 其中 `幻想英雄` 为国内早期少数千万级手机游戏之一
...
### 3D (Unity3D)
* 在开发 2D 项目的同时, 利用业余时间学习研究 `Unity3D`/`Unreal` 等引擎, 所以在新项目能无缝切换到 3D 模式
...
* 具有丰富的开源项目组件使用经验, 按需要引入开源代码, 快速进行二 次开发. 比如使用快速在项目中接入 `Lua` 脚本系
